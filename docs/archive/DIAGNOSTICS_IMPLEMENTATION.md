...
**文件路径**: `ClaudeUsage/Models/DiagnosticReport.swift`
...
struct DiagnosticReport: Codable {
    ...
    func toMarkdown() -> String {
        ...
        **Confidence**: \(confidence.rawValue)
        ...
        - Report generated by ClaudeUsage v\(appVersion)
        - For help, visit: https://github.com/sirpooya/osx-claude-usage/issues
...
**文件路径**: `ClaudeUsage/Helpers/DiagnosticManager.swift`
...
class DiagnosticManager: ObservableObject {
    ...
    func exportReport() -> URL? {
        ...
        let filename = "ClaudeUsage_Diagnostic_\(formatFilenameDate()).md"
    ...
    func saveReportWithDialog() {
        ...
        savePanel.nameFieldStringValue = "ClaudeUsage_Diagnostic_\(formatFilenameDate()).md"
...
**文件路径**: `ClaudeUsage/Views/DiagnosticsView.swift`
...
**文件路径**:
- `ClaudeUsage/Resources/en.lproj/Localizable.strings`
- `ClaudeUsage/Resources/ja.lproj/Localizable.strings`
- `ClaudeUsage/Resources/zh-Hans.lproj/Localizable.strings`
- `ClaudeUsage/Resources/zh-Hant.lproj/Localizable.strings`
...
"diagnostic.suggestion_contact_support" = "Contact developer for help at github.com/sirpooya/osx-claude-usage/issues";
```
...
"diagnostic.suggestion_contact_support" = "github.com/sirpooya/osx-claude-usage/issuesで開発者にお問い合わせください";
```
...
"diagnostic.suggestion_contact_support" = "在 github.com/sirpooya/osx-claude-usage/issues 联系开发者寻求帮助";
```
...
"diagnostic.suggestion_contact_support" = "在 github.com/sirpooya/osx-claude-usage/issues 聯絡開發者尋求協助";
```
...
### Step 1: 创建数据模型
1. 创建 `ClaudeUsage/Models/DiagnosticReport.swift`
2. 复制本文档中的完整代码
3. 编译确认无错误

### Step 2: 创建诊断管理器
1. 创建 `ClaudeUsage/Helpers/DiagnosticManager.swift`
2. 复制本文档中的完整代码
3. 编译确认无错误

### Step 3: 创建诊断视图
1. 创建 `ClaudeUsage/Views/DiagnosticsView.swift`
2. 复制本文档中的完整代码
3. 编译确认无错误

### Step 4: 更新本地化文件
1. 打开 `ClaudeUsage/Resources/en.lproj/Localizable.strings`
2. 在文件末尾添加本文档中的英文字符串
3. 对其他三个语言文件重复此操作
4. 编译确认无错误

### Step 5: 更新 LocalizationHelper
1. 打开 `ClaudeUsage/Helpers/LocalizationHelper.swift`
2. 在 `enum L` 中添加 `enum Diagnostic` 部分
3. 编译确认无错误

### Step 6: 更新 SettingsView
1. 打开 `ClaudeUsage/Views/SettingsView.swift`
...
### 新增文件
- `ClaudeUsage/Models/DiagnosticReport.swift`
- `ClaudeUsage/Helpers/DiagnosticManager.swift`
- `ClaudeUsage/Views/DiagnosticsView.swift`

### 修改文件
- `ClaudeUsage/Views/SettingsView.swift`
- `ClaudeUsage/Helpers/LocalizationHelper.swift`
- `ClaudeUsage/Resources/en.lproj/Localizable.strings`
- `ClaudeUsage/Resources/ja.lproj/Localizable.strings`
- `ClaudeUsage/Resources/zh-Hans.lproj/Localizable.strings`
- `ClaudeUsage/Resources/zh-Hant.lproj/Localizable.strings`
