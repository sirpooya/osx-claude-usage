...
1. 前往 [Releases 页面](https://github.com/f-is-h/ClaudeUsage/releases)
2. 下载最新版本的 `.dmg` 文件
...
- **Issues**: [提交问题或建议](https://github.com/f-is-h/ClaudeUsage/issues)
- **Discussions**: [参与讨论](https://github.com/f-is-h/ClaudeUsage/discussions)
