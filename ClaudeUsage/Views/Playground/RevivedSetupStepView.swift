...
//
// The welcome flow's second page, recovered verbatim from `48850a8^`
// (`reference/Usage4Claude/.../SetupStepView.swift`) after onboarding was cut back to a single
// sign in page. Kept for the playground only: nothing in the shipping app routes here, and the
// live onboarding is still `WelcomeView`'s one page login. It is the reference for this block's
// design, so it is reproduced as it was rather than restyled.

struct RevivedSetupStepView: View {
